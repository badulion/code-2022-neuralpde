...
from . import aTEAM
from .aTEAM import utils
from .aTEAM.nn.modules import FD
from . import expr
from . import initparameters
...
if __name__ == '__main__':
    model = POLYPDE2D(dt=1, dx=1/10, kernel_size=3, max_order=2, constraint='FROZEN', channel_names='u,v')
    x = torch.randn(4, 2, 16, 16, dtype=torch.float64)
    model.multistep(x, 4)
